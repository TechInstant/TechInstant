...
const createIcon = (svgPaths: React.ReactNode, defaultFill = 'none') => {
  return React.forwardRef<SVGSVGElement, IconProps>(
    ({ size = 20, className = 'w-5 h-5', strokeWidth = 2, fill = defaultFill, ...props }, ref) => (
      <svg
        ref={ref}
        width={size}
        height={size}
