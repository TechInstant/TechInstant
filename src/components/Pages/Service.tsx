...
const services = [
    {
        title: "Solution Software",
        description:
            "We develop custom software solutions tailored to your specific business needs. Our team of experts uses the latest technologies to create scalable, efficient, and user-friendly applications.",
        items: [
            {
                icon: (
    ...
    },
    {
        ...
        description:
            "Our enterprise software solutions are designed to streamline your business processes, improve efficiency, and enhance productivity. We offer a range of services from system integration to custom development.",
        items: [
            {
                icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
            ...
            },
            {
                ...
                label: "Custom Enterprise Applications",
            },
            {
                icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
    ...
    },
    {
        title: "Research",
        description:
            "We conduct cutting-edge research in various fields of technology to drive innovation and develop new solutions. Our research areas include AI, machine learning, and data science.",
        items: [
            {
                icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                    ...
                    <React.Fragment key={section.title}>
                        ...
                        <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-4">
                            {section.items.map((item) => (
                                <div
                                    className="flex flex-1 gap-3 rounded-lg border border-[#cedbe8] bg-slate-50 p-4 items-center"
                                    key={item.label}
                                >
                                    <div className="text-[#0d141c]" data-size="24px" data-weight="regular">
                                        {item.icon}
                                    </div>
                                    <h2 className="text-[#0d141c] text-base font-bold leading-tight">{item.label}</h2>
                                </div>
                            ))}
                        </div>
                        {/* Button */}
                        {section.button && (
                            <div className="flex px-4 py-3 justify-start">
                                <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-[#3d99f5] text-slate-50 text-sm font-bold leading-normal tracking-[0.015em]">
                                    <span className="truncate">{section.button.text}</span>
                                </button>
                            </div>
                        )}
                    </React.Fragment>
